...
export async function getTestRecommendations(
  ...
  try {
    ...
    console.log("Gemini raw response:", data); // For debugging
    ...
    console.log("Gemini content:", content); // For debugging
...
{"skills": ["skill1", "skill2", "skill3", "skill4"]}`;
  ...
  try {
    ...
    const content = data.candidates[0].content.parts[0].text;
    console.log("Raw Gemini response for skills:", content);
    ...
    try {
      ...
      console.log("Cleaned content for skills:", cleanedContent);
...
Return ONLY a JSON object in this exact format (no additional text):
{
  ...
  try {
    ...
    const content = data.candidates[0].content.parts[0].text;
    console.log("Raw Gemini response for questions:", content);
    ...
    try {
      ...
      console.log("Cleaned content for questions:", cleanedContent);
